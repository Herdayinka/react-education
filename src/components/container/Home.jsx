  ...
  return (
    <div className="section" id="home">
      <div className="md:flex items-center justify-center">
        <div>
          <div
            className="font-bold text-xs text-Teals
          mb-4"
          >
          ...
          <p className="text-sm leading-7 text-gray mx-w-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo,
            perferendis necessitatibus!
          </p>
          <div className="mt-6">
            <button className="px-6 py-3 font-bold text-white bg-Teals rounded-lg mr-4 text-sm">
              Get Started
            </button>
